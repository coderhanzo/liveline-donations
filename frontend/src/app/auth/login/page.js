            ...
            <div className="flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-2xl shadow-2xl lg:max-w-4xl">
                ...
                <form className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                    ...
                    {/**/}<div className="flex items-center justify-between mt-4">
                        ...
                        <a href="/auth/register/" className="text-xs text-center font-semibold text-black uppercase dark:text-gray-600 hover:underline">Don't have a Bsystems Account? Register Here</a>
